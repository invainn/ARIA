...
const createData = (firstName, middleInitial, lastName, age, teacher, school) => {
    counter += 1;
    return {
        id: counter, firstName, middleInitial, lastName, age, teacher, school,
    };
};
...
class Students extends Component {
  state = {
    ...
    data: [
      createData('Alice', 'P', 'Smith', 9, 'Mr. Jenkins', 'Shaw'),
      createData('Mary', 'B', 'Daniels', 11, 'Mr. Matthews', 'Reno'),
      createData('Ronald', 'E', 'Davidson', 8, 'Mrs. Charles', '-'),
      createData('Scott', 'K', 'Brown', 16, 'Ms. Anderson', '-'),
      createData('Raymond', 'I', 'McMann', 13, 'Mrs. Stevenson', '-'),
      createData('Kenneth', 'B', 'Honeycomb', 18, 'Mr. Franklin', '-'),
      createData('Gary', 'N', 'Peters', 13, 'Mr. Jackson', '-'),
      ...
      createData('Gabriella', 'I', 'Barnett', 12, 'Mr. Ehlers', '-'),
    ],
    page: 0,
    rowsPerPage: 5,
    // open: false,
