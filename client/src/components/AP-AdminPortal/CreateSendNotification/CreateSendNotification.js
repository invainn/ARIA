...
class CreateSendNotification extends Component {
  state = {
  };
      ...
      <CustomerPortalContainer userType={0}>
        ...
        <Paper className={classes.root}>
          <Typography variant="h6" align="center">
              Send notifications to users via either email or SMS.
          </Typography>
...
export default withStyles(styles)(CreateSendNotification);
