...
class ViewModifyNNMTANews extends Component {
  state = {
  };
      ...
      <CustomerPortalContainer userType={0}>
        <div className={classes.pageTitle}>
          <Typography component="h2" variant="h2" gutterBottom align="center">
              View/Modify NNMTA News
          </Typography>
        </div>
        <Paper className={classes.root}>
          <Typography variant="h6" align="center">
              Modify the current news about NNMTA and events.
          </Typography>
...
export default withStyles(styles)(ViewModifyNNMTANews);
